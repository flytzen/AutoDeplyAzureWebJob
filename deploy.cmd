...
call %DNX_RUNTIME%\bin\dnu publish "D:\home\site\repository\src\MyWebJob\project.json" --runtime %DNX_RUNTIME% --out "%DEPLOYMENT_TEMP%\wwwroot\App_Data\Jobs\Continuous\MyWebJob" %SCM_DNU_PUBLISH_OPTIONS%
IF !ERRORLEVEL! NEQ 0 goto error
